...
# surname = input("Youe surname pls: ")

# x = list(surname)  # It can be restored by .join
...
# age_typed = input("How old are you?: ")

# age = int(age_typed)

# easy_way = int(2023 - age)
